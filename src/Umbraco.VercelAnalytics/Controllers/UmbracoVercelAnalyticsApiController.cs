...
namespace Umbraco.VercelAnalytics.Controllers
{
    ...
    public class UmbracoVercelAnalyticsApiController : UmbracoVercelAnalyticsApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public UmbracoVercelAnalyticsApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
